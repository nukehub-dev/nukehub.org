...
- `ADMIN_EMAILS` — comma-separated NukeAuth user emails allowed to access admin endpoints.
- `AUTH_URL`, `AUTH_REALM`, `AUTH_CLIENT_ID` — NukeAuth (Keycloak-backed) config for admin token verification.
