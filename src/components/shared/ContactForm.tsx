...
const inquiryHelpers: Record<string, { placeholder: string; proTip: string }> =
    {
        Sponsorship: {
            ...
            proTip: "Include budget range, partnership duration, and any specific events or initiatives you want to support.",
        },
        "Resource Donation": {
            placeholder:
                "Describe the resources you would like to donate — compute credits, software licenses, datasets, hardware...",
            proTip: "Mention estimated value, transfer terms, and how NukeHub can acknowledge your contribution.",
        },
        Volunteering: {
            placeholder:
                "Tell us about your background, skills, availability, and what you would love to contribute to...",
            proTip: "Share relevant experience, weekly time commitment, and the teams or projects that excite you most.",
        },
        General: {
            placeholder:
                "How can we help you? Share as much detail as you can...",
            proTip: "The more context you provide — goals, timeline, and stakeholders — the faster we can respond with a useful answer.",
        },
    };
