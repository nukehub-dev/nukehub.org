...
interface BrandIconProps extends React.SVGProps<SVGSVGElement> {
  name: 'github' | 'linkedin' | 'twitter' | 'facebook' | 'instagram' | 'youtube' | 'gitlab' | 'bitbucket' | 'stackoverflow';
  size?: number;
}
...
const icons: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
  ...
  gitlab: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M23.955 13.587l-1.342-4.135-2.664-8.189a.455.455 0 00-.867 0L16.418 9.45H7.582L4.918 1.263a.455.455 0 00-.867 0L1.387 9.452.045 13.587a.924.924 0 00.331 1.023L12 23.054l11.624-8.443a.92.92 0 00.331-1.024z"/>
    </svg>
  ),
  bitbucket: (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
