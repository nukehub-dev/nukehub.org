...
export function StoryTimeline({ title, milestones }: Props) {
    ...
    <section className="py-24 overflow-hidden">
      <div className="mx-auto max-w-5xl px-4">
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-center text-3xl font-semibold tracking-tight text-foreground sm:text-4xl mb-16"
          >
            {title}
          </motion.h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`ml-16 sm:ml-0 sm:w-1/2 ${
                      ...
                      >
                        <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-card/50 p-6 sm:p-8 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20">
                          {/* Gradient accent */}
