...
export function ValuesGrid({ title, items }: Props) {
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-2xl border border-border/60 bg-card/50 p-6 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 ${
