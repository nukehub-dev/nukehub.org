            ...
            {points.map((point, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-2xl border border-border/60 bg-card/50 backdrop-blur-sm p-8 transition-all duration-300 hover:shadow-xl ${colors.glow} border-l-[3px] ${colors.border}`}
                >
                  {/* Number watermark */}
                  ...
                  <div className="relative z-10">
                    <div
                      className={`flex h-14 w-14 items-center justify-center rounded-2xl ${colors.bg} ${colors.text}`}
                    >
                      <Icon size={28} />
                    </div>
